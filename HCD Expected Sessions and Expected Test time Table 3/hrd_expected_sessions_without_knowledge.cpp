...
double computepequal2(int n,vector<vector<int> >&ans)
{
	int m=ans.size();
    int sum=0;
    int p=2;
...
double computepequal3(int n,vector<vector<int> >&ans)
{
    int m=ans.size();
    int sum=0;
    int p=3;
...
double computepequal4(int n,vector<vector<int> >&ans)
{
    int m=ans.size();
    int sum=0;
    int p=4;
...
int main() 
{
    ...
    while(r>=0){
        ...
        else
        {
            ...
            get(s,ans);
            if(p==2)
		    	avg_sessions[r]=computepequal2(n,ans);
		    else if(p==3)
		    	avg_sessions[r]=computepequal3(n,ans);
		    else if(p==4)
		    	avg_sessions[r]=computepequal4(n,ans);
        }
